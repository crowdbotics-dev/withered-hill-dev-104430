"""
Django settings for withered_hill_dev_104430 project.
...
ROOT_URLCONF = 'withered_hill_dev_104430.urls'
...
WSGI_APPLICATION = 'withered_hill_dev_104430.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_hill_dev_104430 API",
    "DESCRIPTION": "API documentation for withered_hill_dev_104430 App",
    "VERSION": "v1",
}
