...
## Project Structure
    ...
    ├── withered_hill_dev_104430  # Django project configurations
...
1. Clone this repo and `cd withered_hill_dev_104430`
...
2. Clone this repo and `cd withered_hill_dev_104430`
